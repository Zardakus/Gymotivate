...
namespace Gymotivate.Migrations
{
    ...
    [Migration("20231008130037_CriandoTabelaConquistasEVinculandoUser")]
    partial class CriandoTabelaConquistasEVinculandoUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Gymotivate.Models.ConquistasModel", b =>
                {
                    ...
                    b.Property<string>("ConquistaExp")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ConquistaName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Gymotivate.Models.GrupoConquistasModel", b =>
                {
                    ...
                    b.Property<string>("GroupExpTotal")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
